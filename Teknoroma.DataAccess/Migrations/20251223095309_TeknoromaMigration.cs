...
{
    /// <inheritdoc />
    public partial class TeknoromaMigration : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductOfStores", x => new { x.ProductID, x.StoreID });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductOfOrders", x => new { x.ProductID, x.OrderID });
                    table.ForeignKey(
                        name: "FK_ProductOfOrders_Orders_OrderID",
                        column: x => x.OrderID,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductOfOrders_OrderID",
                table: "ProductOfOrders",
                column: "OrderID");

            migrationBuilder.CreateIndex(
                name: "IX_ProductOfStores_StoreID",
